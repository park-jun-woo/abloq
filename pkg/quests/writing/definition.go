...
//ff:what 집필 퀘스트 Definition — reins gate.Definition(Seed/Render/Prepare/Rules) 구현체, 상태 없는 마커
package writing

// Definition is the writing quest's reins gate.Definition implementation.
