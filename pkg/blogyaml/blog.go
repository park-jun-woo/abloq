...
//ff:what blog.yaml 스키마 v1 최상위 — 블로그 하나의 전 선언 (site/languages/sections/structure/geo/deploy)
//ff:why 후속 Phase 키(min_meaningful_diff, taxonomy 등)는 섹션 구조체에 필드만 추가하면 되도록 평탄한 6분할 유지
package blogyaml
