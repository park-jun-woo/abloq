...
//ff:what CLAUDE.md 디렉토리 규약 섹션 — SSOT/콘텐츠/레이아웃/생성물/큐/IaC 경로와 취급 규칙
package claudemd

// dirsSection renders the directory conventions (fixed text — the layout is
// the same for every abloq blog).
func dirsSection() string {
	return `## 디렉토리 규약
